...
/**
 * Created by GYH on 2021/4/28
 */
public class Reservoir extends Node{
    /**
     * Reservoir mixing regimes.
     */
    public enum MixType {
        /**
         * First in, first out nmka.model
         */
        FIFO(2, Keywords.w_FIFO),
        /**
         * Last in, first out nmka.model
         */
        LIFO(3, Keywords.w_LIFO),
        /**
         * 1-compartment nmka.model
         */
        MIX1(0, Keywords.w_MIXED),
        /**
         * 2-compartment nmka.model
         */
    ...
    /**
     * Reservoir area (feet^2).
     */
    private double area;
    /**
     * Reservoir volume (feet^3).
     */
    //private double v;
    /**
